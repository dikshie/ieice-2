...
\begin{itemize}
	...
	\item $s_2 = (CDN-P2P, P^{s_2})$ : the ISP decides recommends P2P and offers a subscription fee $P^{s_2} \le P^{s_1}$.
\end{itemize}
...
If ISP decides to employ P2P-CDN then user can accept ISP strategy or decline ISP strategy.
