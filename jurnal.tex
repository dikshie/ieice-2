...
We present a cooperative model between P2P and CDN using simple a single bitrate for video streaming as shown in Fig.\ref{fig:twotier2}. 
...
\end{center}
\caption{Strategic game between ISP and users}
\label{fig:gametree}
\vspace{-2mm}
\end{figure}
