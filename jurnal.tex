...
All arrivals after that point are admitted as leechers.     
...
Figure \ref{fig:cdf} shows CDN of $X$ for $U_s=0.1, U_s=0.5, and U_s=0.8$ for different admission policy. 
