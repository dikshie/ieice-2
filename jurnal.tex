...
\begin{eqnarray*}
P(\text{support min capacity}) &=& P(\frac{U_p}{n_s} = 1+RR-min(u_s,RR))\\
&=&F(1+RR-min(u_s,RR))\\
\end{eqnarray*}
...
\begin{eqnarray*}
P \left(\frac{(U_p/n_s) - \rho}{\sqrt{\rho}}=\frac{1+RR-min(u_s,RR) - \rho}{\sqrt{\rho}}\right)\\
=\Phi \left( \frac{1+RR-min(u_s,RR) - \rho}{\sqrt{\rho}} \right) \\
\end{eqnarray*}
