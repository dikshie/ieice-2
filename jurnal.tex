...
\end{center}
\caption{$\delta$ between streategy $s_1$ and $s_2$ with $U_s$ variation and $\gamma$ variation.The intersection of lines with x-axis = 0 is the point where ISP minimum payoff.Below the x-axis=0 where the lines cross means ISP get benefit and top of the x-axis=0 of the lines means ISP is not get benefit or loss of money because too many seeders.}
\label{fig:delta}
\vspace{-2mm}
 \end{figure}
