...
In recent year, xDSL networks are deployed worldwide and broadband acess network helps the P2P application to perform better.
...
%%%%%%%%%%%%%%%% %%%%%% SYSTEM DESCRIPTION %%%%%%%%%%%%%%%%%%%%%%%
\section{System D escription}\label{description}
...
For big ISP different CDN proxies in level0 can be put on different cities or different geographically areas.
